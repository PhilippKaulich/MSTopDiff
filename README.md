...
| Mass Feature Filter > From ... to ... min  | Minimal and maximal start retention time of mass features that are considered for the calculation of mass differences |
...
## Results
_MSTopDiff can generate three different plots._
...
- v1.1.0 (16 November 2022) Added mass feature retention time filter, added axis labels and legend for generated plots, fixed bug with retention time values in plots, fixed bug with retention time values for retention time shift analysis, minor bug fixes and performance optimization. 
